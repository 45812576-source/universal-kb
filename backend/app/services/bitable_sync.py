...
class BitableSync:
    ...
    async def full_sync(
        ...
        # 注册/更新 BusinessTable
        self._register_table(db, table_name, display_name or table_name, app_token, table_id, ddl, owner_id)
    ...
    async def incremental_sync(
        ...
        app_token = rules.get("bitable_app_token", "")
        table_id = rules.get("bitable_table_id", "")

...
_STUDIO_EVENT_MAP: dict[str, EventName] = {
    ...
    "card_patch": EventName.CARD_PATCH,
    "card_status_patch": EventName.CARD_STATUS_PATCH,
    "artifact_patch": EventName.ARTIFACT_PATCH,
    "stale_patch": EventName.STALE_PATCH,
    "queue_window_patch": EventName.QUEUE_WINDOW_PATCH,
...
class SkillStudioAgentProfile:
    ...
    async def run_stream(
        ...
        *,
        ...
        active_card_source_card_id: Optional[str] = None,
        active_card_staged_edit_id: Optional[str] = None,
        active_card_phase: Optional[str] = None,
        active_card_validation_source: Optional[dict[str, Any]] = None,
        active_card_file_role: Optional[str] = None,
        active_card_handoff_policy: Optional[str] = None,
        active_card_route_kind: Optional[str] = None,
        active_card_destination: Optional[str] = None,
        active_card_return_to: Optional[str] = None,
        active_card_queue_window: Optional[dict[str, Any]] = None,
        active_card_contract_id: Optional[str] = None,
        active_card_context_summary: Optional[str] = None,
